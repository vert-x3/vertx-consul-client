...
var ConsulService = function(j_val) {
  ...
  this.putValue = function(pair, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_consulService["putValue(io.vertx.ext.consul.KeyValuePairOptions,io.vertx.core.Handler)"](pair != null ? new KeyValuePairOptions(new JsonObject(JSON.stringify(pair))) : null, function(ar) {
      if (ar.succeeded()) {
  ...
  this.createSession = function(session, idHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_consulService["createSession(io.vertx.ext.consul.Session,io.vertx.core.Handler)"](session != null ? new Session(new JsonObject(JSON.stringify(session))) : null, function(ar) {
      if (ar.succeeded()) {
        idHandler(ar.result(), null);
      } else {
        idHandler(null, ar.cause());
