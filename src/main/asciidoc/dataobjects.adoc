...
|[[maxAgeSeconds]]`@maxAgeSeconds`|`Number (long)`|-
|[[near]]`@near`|`String`|-
|[[nodeMeta]]`@nodeMeta`|`String`|-
|[[relayFactor]]`@relayFactor`|`Number (byte)`|-
|[[requireConsistent]]`@requireConsistent`|`Boolean`|-
|[[staleIfErrorSeconds]]`@staleIfErrorSeconds`|`Number (long)`|-
|[[token]]`@token`|`String`|-
|[[useCache]]`@useCache`|`Boolean`|-
|[[waitHash]]`@waitHash`|`String`|-
|[[waitIndex]]`@waitIndex`|`Number (long)`|-
|[[waitTimeSeconds]]`@waitTimeSeconds`|`Number (long)`|-
|===
